          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between gap-5">
                ...
                <p  className="font-[200]  text-white text-[16px]  leading-snug">At Quadbreak Studios, we bring game worlds to life with high-quality 3D art, environments, and assets tailored for AAA, indie, and mobile games. </p>
              </div>
            </div>
          ))}
        </div>
