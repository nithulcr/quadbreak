    ...
    <section ref={sectionRef} className="py-14 md:py-24 relative overflow-hidden bg-[var(--background)]">
      ...
      <div className="max-w-[1450px] mx-auto px-5 lg:px-10">
        ...
        <div className="flex lg:hidden gap-6 overflow-x-auto snap-x snap-mandatory pb-4 -mx-5 px-5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {[...Array(9)].map((_, i) => (
            <div key={i} className="testimonial-card snap-center shrink-0 w-[320px] rounded-[28px] border border-white/10 bg-black/20 backdrop-blur-md transition-all duration-500 p-6 flex flex-col gap-5">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 relative rounded-full overflow-hidden">
                  <Image src="/images/user.png" alt="John Doe" fill sizes="50px" className="object-cover" />
                </div>
        ...
        {/* Desktop staggered grid — original layout, unchanged */}
        <div ref={desktopGridRef} className="hidden lg:grid grid-cols-10 gap-8">
          <div className="testimonial-card col-span-3 rounded-[28px] border border-white/5 bg-black/20 backdrop-blur-lg transition-all duration-500 p-6 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 relative rounded-full overflow-hidden">
                <Image src="/images/user.png" alt="John Doe" fill sizes="50px" className="object-cover" />
              </div>
          ...
          <div className="testimonial-card col-span-4 rounded-[28px] border border-white/10 bg-black/20 backdrop-blur-md transition-all duration-500 p-6 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 relative rounded-full overflow-hidden">
                <Image src="/images/user.png" alt="John Doe" fill sizes="50px" className="object-cover" />
              </div>
          ...
          <div className="testimonial-card col-span-3 rounded-[28px] border border-white/10 bg-black/20 backdrop-blur-md transition-all duration-500 p-6 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 relative rounded-full overflow-hidden">
                <Image src="/images/user.png" alt="John Doe" fill sizes="50px" className="object-cover" />
              </div>
