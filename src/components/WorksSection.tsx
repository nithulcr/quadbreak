...
const WorkCard = ({
  ...
  <div
    className={`about-card bg-white/4 group relative top-0 aspect-[1/1.08] overflow-hidden transition-[top,box-shadow] duration-500 ease-out hover:top-[-10px] ${className}`}
  >
    <img
      src={card.image}
      alt={card.title}
