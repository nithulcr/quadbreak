  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] px-5">
        ...
        {/* Cards */}
        <div ref={cardsRef} className="max-w-[1000px] mx-auto grid gap-12 ">
          {categories.map((cat, i) => {
            return (
              <article
                key={cat.number}
                className={` group relative grid md:grid-cols-2 overflow-hidden  `}
              >

               
                {/* Image */}
                <div className="cat4-img relative  aspect-[16/9] w-full overflow-hidden rounded-[18px] bg-[#141414] border border-[var(--green)]/70">
                  <Image
                    src={cat.image}
               ...
               <div className="bg-[#141414] p-5 md:p-7 rounded-[18px] flex flex-col justify-between mt-15 ml-[-100px] z-99">
                ...
                {/* Description */}
                <p className="mt-4 text-sm font-light leading-relaxed text-white/60 max-w-[500px]">
                  {cat.description}
                </p>
               </div>
